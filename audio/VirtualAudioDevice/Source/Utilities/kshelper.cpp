...
Abstract:
    ...
    Helper functions for virtual audio device
--*/
...
#pragma code_seg("PAGE")
NTSTATUS
VirtualAudioDevicePropertyDispatch
(
    _In_ PPCPROPERTY_REQUEST PropertyRequest
)
/*++
    Handles and dispatches a VIRTUALAUDIODEVICE_PROPERTY_ITEM.

    Use this as the property handler only if the property item is a
    VIRTUALAUDIODEVICE_PROPERTY_ITEM.
--*/
{
    PAGED_CODE();

    VIRTUALAUDIODEVICE_PROPERTY_ITEM* item = (VIRTUALAUDIODEVICE_PROPERTY_ITEM*)PropertyRequest->PropertyItem;
