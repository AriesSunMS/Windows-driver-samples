...
Abstract:
    ...
    Declaration of Virtual Audio Device data saving class. This class supplies services
to save data to disk.

--*/

#ifndef _VIRTUALAUDIODEVICE_SAVEDATA_H
#define _VIRTUALAUDIODEVICE_SAVEDATA_H
