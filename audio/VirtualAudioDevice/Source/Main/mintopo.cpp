...
NTSTATUS
CreateMiniportTopologyVirtualAudioDevice
( 
...
--*/
{
    ...
    return CMiniportTopologyVirtualAudioDevice::GetDescription(OutFilterDescriptor);        
} // GetDescription
...
--*/
{
    ...
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Init: CMiniportTopologyVirtualAudioDevice::Init failed, 0x%x", ntStatus)),
        Done);
