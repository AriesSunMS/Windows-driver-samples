...
Abstract:
    ...
    all virtual audio device drivers
--*/
...
CMiniportTopologyVirtualAudioDevice::CMiniportTopologyVirtualAudioDevice
(
...
} // CMiniportTopologyVirtualAudioDevice
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyVirtualAudioDevice::DataRangeIntersection
( 
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyVirtualAudioDevice::GetDescription
( 
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyVirtualAudioDevice::Init
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyVirtualAudioDevice::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyVirtualAudioDevice::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyVirtualAudioDevice::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyVirtualAudioDevice::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyVirtualAudioDevice::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyVirtualAudioDevice::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyVirtualAudioDevice::GenerateEventList]"));
