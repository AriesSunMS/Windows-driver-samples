...
#ifndef _VIRTUALAUDIODEVICE_DEFINITIONS_H_
#define _VIRTUALAUDIODEVICE_DEFINITIONS_H_
...
#define STATIC_PID_VIRTUALAUDIODEVICE\
    0x836ba6d1, 0x3ff7, 0x4411, 0x8b, 0xcd, 0x46, 0x95, 0x53, 0x45, 0x2d, 0xce
DEFINE_GUIDSTRUCT("836BA6D1-3FF7-4411-8BCD-469553452DCE", PID_VIRTUALAUDIODEVICE);
#define PID_VIRTUALAUDIODEVICE DEFINE_GUIDNAMED(PID_VIRTUALAUDIODEVICE)

// Pool tag used for VIRTUALAUDIODEVICE allocations
#define VIRTUALAUDIODEVICE_POOLTAG               'VADV'

// Debug module name
#define STR_MODULENAME              "VIRTUALAUDIODEVICE: "
...
#endif // _VIRTUALAUDIODEVICE_DEFINITIONS_H_
