...
#ifndef _VIRTUALAUDIODEVICE_COMMON_H_
#define _VIRTUALAUDIODEVICE_COMMON_H_
...
//
//=============================================================================
typedef struct _VIRTUALAUDIODEVICE_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} VIRTUALAUDIODEVICE_DEVPROPERTY, PVIRTUALAUDIODEVICE_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with VIRTUALAUDIODEVICE.<TopoName>.szPname in the inf's [Strings] section
    ...
    const VIRTUALAUDIODEVICE_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with VIRTUALAUDIODEVICE.<WaveName>.szPname in the inf's [Strings] section
    ...
    const VIRTUALAUDIODEVICE_DEVPROPERTY*       WaveInterfaceProperties;
...
#endif  //_VIRTUALAUDIODEVICE_COMMON_H_
