...
#ifndef _VIRTUALAUDIODEVICE_MICARRAYTOPO_H_
#define _VIRTUALAUDIODEVICE_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyVirtualAudioDevice,
...
public:
    ...
    (
        ...
        CMiniportTopologyVirtualAudioDevice(FilterDesc, DeviceMaxChannels),
...
#endif // _VIRTUALAUDIODEVICE_MICARRAYTOPO_H_
