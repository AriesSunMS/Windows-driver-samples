...
#ifndef _VIRTUALAUDIODEVICE_MICARRAYWAVTABLE_H_
#define _VIRTUALAUDIODEVICE_MICARRAYWAVTABLE_H_
...
static
VIRTUALAUDIODEVICE_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
...
#endif // _VIRTUALAUDIODEVICE_MICARRAYWAVTABLE_H_
