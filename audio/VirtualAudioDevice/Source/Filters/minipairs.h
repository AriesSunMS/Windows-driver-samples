...
#ifndef _VIRTUALAUDIODEVICE_MINIPAIRS_H_
#define _VIRTUALAUDIODEVICE_MINIPAIRS_H_
...
NTSTATUS
CreateMiniportWaveRTVirtualAudioDevice
( 
    _Out_       PUNKNOWN *,
    _In_        REFCLSID,
    _In_opt_    PUNKNOWN,
...
#endif // _VIRTUALAUDIODEVICE_MINIPAIRS_H_
